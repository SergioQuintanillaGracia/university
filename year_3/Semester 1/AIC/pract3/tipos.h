...
typedef struct {
    ...
    boolean rs1_usa_abi;  /* Índica si el registro usa el ABI o el formato numérico */

    ubyte rs2; /* Índice del registro fuente 2 */
    boolean rs2_usa_abi;  /* Índica si el registro usa el ABI o el formato numérico */

    ubyte rs3; /* Índice del registro fuente 3 */
    boolean rs3_usa_abi;  /* Índica si el registro usa el ABI o el formato numérico */

    ubyte rm; /* Índice del modo de rendondeo */

    ubyte rd; /* Índice del registro destino */
    boolean rd_usa_abi;  /* Índica si el registro usa el ABI o el formato numérico */

    dword imm; /* Valor Inmediato. RiscV R32I usa hasta 20 bits */

 //   dword PC; /* Posición de memoria de la instrucción */
    uword valor; /* Codificacion */

    char etiqueta[L_ETIQ]; /* Posible etiqueta */
    char texto[SHORT_STR]; /* Instrucción decodificacada */
} instruccion_t;
