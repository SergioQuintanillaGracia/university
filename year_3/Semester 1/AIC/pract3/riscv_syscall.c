...
boolean process_syscall(dword PC) {
    dword call_nr,
            param1,
            param2;
    ...
    switch (call_nr) {
        ...
        case 4: // print string
            ...
            do {
                ivalue = lee_mem_datos(mmem, param1 + i, t_byte, &dummy, PC);
                achar = ivalue.int_d;
        ...
        case 8: // read string
            ...
            do {
                achar = dst[i];
                ivalue.int_d = achar;
                escribe_mem_datos(mmem, indice_byte(param1 + i), ivalue, t_byte, SI, PC);
                i++;
