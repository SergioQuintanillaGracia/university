// This is a custom version not asked in the practice that tries
// to solve the biggest bottleneck left
...
int main(int argc, char **argv)
{
    ...
    {
        long long privateHist[BINS];

        for (step = 0; step < STEPS; ++step) {
            memset(privateHist, 0, sizeof(privateHist));
